 ...
 */
final class Version20191228194648 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE advert ADD category_id INT DEFAULT NULL, ADD user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE advert DROP category_id, DROP user_id');
    }
}
