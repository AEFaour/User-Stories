 ...
 */
final class Version20191229031803 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE advert (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, advert_user_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, text LONGTEXT NOT NULL, created_at DATETIME NOT NULL, photo VARCHAR(128) DEFAULT NULL, INDEX IDX_54F1F40B12469DE2 (category_id), INDEX IDX_54F1F40BD2093C3 (advert_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
